...
public class CompressionCategory implements IRecipeCategory<CompressorRecipeHelper.CustomRecipeData> {
    public static final IRecipeType<CompressorRecipeHelper.CustomRecipeData> RECIPE_TYPE =
            IRecipeType.create(PureMashTweaks.MODID, "compression", CompressorRecipeHelper.CustomRecipeData.class);

    private static final Identifier TEXTURE = Identifier.fromNamespaceAndPath(PureMashTweaks.MODID, "textures/gui/jei/tables/multifunctional_compressor/compression_gui.png");
    ...
    public @NotNull Component getTitle() {
        return Component.translatable("jei.category.puremashtweaks.compression");
    }
    ...
    public void draw(@NotNull CompressorRecipeHelper.CustomRecipeData recipe, @NotNull IRecipeSlotsView recipeSlotsView, @NotNull net.minecraft.client.gui.GuiGraphicsExtractor graphics, double mouseX, double mouseY) {
        ...
        long durationS = 1000L;
        long durationBP = 1000L;
        ...
        if (fillWidth > 0) {
            graphics.blit(RenderPipelines.GUI_TEXTURED, SILHOUETTES_TEXTURE, 62, 21, 0.0F, 0.0F, fillWidth, 16, 50, 35);
        }
