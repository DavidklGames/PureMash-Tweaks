...
public class DustCategory implements IRecipeCategory<CompressorRecipeHelper.CustomRecipeData> {
    ...
    private static final Identifier TEXTURE = Identifier.fromNamespaceAndPath(PureMashTweaks.MODID, "textures/gui/jei/tables/multifunctional_compressor/dust_gui.png");
