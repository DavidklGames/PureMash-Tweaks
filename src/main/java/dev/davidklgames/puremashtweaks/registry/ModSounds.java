...
public class ModSounds {
    ...
    public static final DeferredHolder<SoundEvent, SoundEvent> NEW_HORIZONS =
            SOUNDS.register("new_horizons", () -> SoundEvent.createVariableRangeEvent(Identifier.fromNamespaceAndPath("puremashtweaks", "new_horizons")));
