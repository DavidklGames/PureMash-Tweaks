...
public abstract class BaseContainerCompressionScreen<T extends AbstractContainerMenu> extends AbstractContainerScreen<T> {
    protected final Identifier texture;

    public BaseContainerCompressionScreen(T menu, Inventory inv, Component title, Identifier texture, int width, int height) {
